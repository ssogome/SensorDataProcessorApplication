...
{
    [EventSource(Name = "MyCompany-SensorDataProcessorApplication-SensorDataProcessor")]
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        internal void ServiceMessage(SensorDataProcessor sensorDataProcessor, string v, string data)
        {
